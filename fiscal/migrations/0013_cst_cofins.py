    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "verbose_name_plural": "CST COFINS",
                "db_table": "fiscal_cst_cofins",
                "ordering": ("codigo",),
                "indexes": [
                    models.Index(fields=["ativo", "codigo"], name="fiscal_cstcof_ativo_cod_idx"),
                    models.Index(fields=["tipo_operacao", "ativo"], name="fiscal_cstcof_tipo_ativo_idx"),
                ],
            },
        ),
    ]
