...
class Migration(migrations.Migration):
    dependencies = [
        ("fiscal", "0010_seed_ncm_homologacao"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ("codigo",),
                "indexes": [
                    models.Index(fields=["ativo", "codigo"], name="fiscal_cstpis_ativo_cod_idx"),
                    models.Index(fields=["tipo_operacao", "ativo"], name="fiscal_cstpis_tipo_ativo_idx"),
                ],
            },
        ),
    ]
