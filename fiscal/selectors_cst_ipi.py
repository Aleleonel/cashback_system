...
def get_csts_ipi(*, busca="", somente_ativos=False, tipo_operacao=""):
    registros = CSTIPI.objects.all().order_by("codigo")
...
def get_cst_ipi(*, cst_ipi_id):
    return CSTIPI.objects.get(id=cst_ipi_id)
